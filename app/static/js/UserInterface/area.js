define([
    ...
    "exports"
], function (InteractionManager, Loadout, MissionInfo, exports) {
    ...
    _.extend(exports, {
        areas : [new Area(MissionInfo.generateMissions()),new Area(MissionInfo.generateMissions()), new Area(MissionInfo.generateMissions()),new Area([MissionInfo.createMissionInfo("boss","boss")])],
        //Makes corrections to the activity of areas, and activates boss challenge, if neccesary
        updateAreaStatus : function(stars){
            var curMis = MissionInfo.currentMissionIndex;
            var curArea = MissionInfo.currentAreaIndex;
