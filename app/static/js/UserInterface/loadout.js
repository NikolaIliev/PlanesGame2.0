    ...
    return {
        ...
        drawCurrentSkills : function(){
            ...
            for(var i=0;i<this.current.length;i++){
                ...
                $("<div/>")
                    ...
                    .on("click",function(){
                        Game.unlockedSkills.push(self.current.splice($(this).attr("currentSkillIndex"),1)[0]);
                        self.drawUnlockedSkills();
                        self.drawCurrentSkills();
                    })
            ...
            for(var i=0;i<Game.unlockedSkills.length;i++){
                ...
                $("<div/>")
                    ...
                    .on("click",function(){
                        ...
                        self.current.push(Game.unlockedSkills.splice($(this).attr("skillIndex"),1)[0]);
                        self.drawUnlockedSkills();
                        self.drawCurrentSkills();
                    })
                    .appendTo(".skillBox");
            }
            this.attachIconDescriptionEvents();
        },
        ...
        drawLoadoutScreen : function(){
            ...
            $("<div id='closePrompt'>X<div/>")
                .on("click",function(){
                    ...
                    var count = self.current.length;
                    for(var i=0;i<count;i++){
                        Game.unlockedSkills.push(self.current.splice(0,1)[0]);
                    }
            ...
            $("<div>Confirm</div>")
                ...
                .on("click",function(){
                    InteractionManager.setPlayerSkills(self.current);
                    var count = self.current.length;
                    for(var i=0;i<count;i++){
                        Game.unlockedSkills.push(self.current.splice(0,1)[0]);
                    }
        ...
        attachIconDescriptionEvents : function(){
            ...
            $(".skillIcon").on("mouseenter",function(){
                $("<div/>").addClass("descriptionBox gameWindow").html(self.generateDescription($(this))).appendTo("#gameScreen")
            });
